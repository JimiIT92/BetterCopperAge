...
[![](https://img.shields.io/badge/Fabric-1.21.9--0.132.3-informational?logo=curseforge)](https://fabricmc.net/")
[![](http://cf.way2muchnoise.eu/full_xxxxxxx_downloads.svg)](https://www.curseforge.com/minecraft/mc-mods/hendrixs-better-copper-age)
[![](https://img.shields.io/modrinth/dt/xxxxxxxx?logo=modrinth&label=Modrinth&color=darkgreen)](https://modrinth.com/mod/hendrixs-better-copper-age)
...
Unfortunately, these have not been added with the Copper Age Drop.... until now!
...
`bettercopperage:copper_golem_output_containers`. You can find the list of supported containers [here](https://github.com/JimiIT92/BetterCopperAge/blob/master/src/main/resources/data/bettercopperage/tags/block/copper_golem_output_containers.json)
...
You can find the full list [here](https://github.com/JimiIT92/BetterCopperAge/blob/master/src/main/resources/data/minecraft/tags/item/shearable_from_copper_golem.json)
...
Anyone can contribute to Better Copper Age, suggesting their ideas [using the Feature Request module](https://github.com/JimiIT92/BetterCopperAge/issues/new?assignees=JimiIT92&labels=enhancement&template=feature_request.md&title=)
...
You can download Better Copper Age on [CurseForge](https://www.curseforge.com/minecraft/mc-mods/hendrixs-better-copper-age) or [Modrinth](https://modrinth.com/project/hendrixs-better-copper-age/versions).
...
Better Copper Age is, and **<ins>always</ins>** will be, **<ins>FREE TO USE</ins>**.

If someone asked you some money to download Better Copper Age, I am afraid to tell you that you got scammed! 😥
