...
/**
 * {@link BetterFallDrop Better Fall Drop} {@link BlockEntityType Block Entity Types}
 */
public final class BFDBlockEntityTypes {

    //#region Block Entity Types

    public static final BlockEntityType<BFDCampfireBlockEntity> CAMPFIRE = registerBlockEntityType("campfire", BFDCampfireBlockEntity::new, BFDBlocks.COPPER_CAMPFIRE);
