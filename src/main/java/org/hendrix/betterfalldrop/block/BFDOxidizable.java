...
public interface BFDOxidizable extends Oxidizable {
    ...
    Supplier<BiMap<Block, Block>> BFD_OXIDATION_LEVEL_INCREASES = Suppliers.memoize(() -> ImmutableBiMap.<Block, Block>builder()
            ...
            .put(BFDBlocks.COPPER_RAIL, BFDBlocks.EXPOSED_COPPER_RAIL)
            .put(BFDBlocks.EXPOSED_COPPER_RAIL, BFDBlocks.WEATHERED_COPPER_RAIL)
            .put(BFDBlocks.WEATHERED_COPPER_RAIL, BFDBlocks.OXIDIZED_COPPER_RAIL)
            .build()
    );
